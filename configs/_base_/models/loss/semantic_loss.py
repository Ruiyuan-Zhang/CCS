...
_C.collision_loss_w = 0.0      # the weight of collision loss
_C.collision_loss_C = 1.0      # define the collision loss of XX, e.g. Chair,
_C.balance_loss_layers_weights = 1.0
_C.balance_loss_w = 1.0
